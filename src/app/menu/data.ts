  ...
  categories: [
      ...
      items: [
        {
          ...
          fullDescription:
            'Три плотных сырника с черничным конфи, подаются со сметаной и хрустящим крамблом.',
          ingredients: [
            'Масса на сырники',
        ...
        },
        {
          ...
          fullDescription:
            'Небольшие шарики сырников, подаются со сливочным соусом, манговым пюре и фисташковой пастой.',
          ingredients: [
            'Масса на сырники',
        ...
        },
        {
          ...
          fullDescription:
            'Три простых сырника без начинок, подаются с предлагаемыми конфи и добавками.',
          ingredients: [
            'Творог',
            'Сахар',
            'Муку пшеничную',
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: 'grechotto',
          name: 'Гречотто со шпинатом и пашотом',
          shortDescription: 'Ризотто из зелёной гречки с песто и яйцом пашот',
          fullDescription:
            'Зелёная гречка, приготовленная как ризотто с песто, шпинатом и яйцом пашот, посыпанная пармезаном.',
          ingredients: [
            'Гречка зелёная',
            'Песто',
            'Шпинат',
          ...
          method:
            'Гречку готовят с песто до кремовой консистенции, добавляют шпинат, украшают пашотом.',
          image: '/menu/egg/glaz.jpg',
          chip: '—'
        },
        {
