...
async function main(): Promise<void> {
  ...
  const assistant = await openai.beta.assistants.create({
    ...
    Работа с меню и позициями
                Когда формируешь ответ о составе или аллергенах блюда:
            1) Считывай ингредиенты из описания блюда.
            2) Если есть поле item.sauceIds, для каждого соуса:
                – из справочника соусов (файл finch_sauces.md) подтягивай массив ingredients.
        – теперь ты знаешь ингредиенты соуса в блюде, учитывай что и они могут быть аллергенами в блюде.
        ...
        Состав, описание, гастропары:
            ...
            У соусов состав прописан в файле finch_sauces.md
